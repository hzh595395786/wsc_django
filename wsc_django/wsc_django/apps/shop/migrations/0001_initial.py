    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop_county', models.IntegerField(default=0, verbose_name='店铺所在国家编号')),
                ('shop_province', models.IntegerField(default=0, verbose_name='店铺所在省份编号')),
                ('shop_city', models.IntegerField(default=0, verbose_name='店铺所在城市编号')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='店铺创建时间')),
                ('description', models.CharField(default='', max_length=256, verbose_name='店铺描述')),
