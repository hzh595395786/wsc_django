    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=128, verbose_name='商品分组描述')),
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.productgroup', verbose_name='该商品分组的父级ID')),
            ],
            options={
                'verbose_name': '货品分组',
